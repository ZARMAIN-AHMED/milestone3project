      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5  h-full p-12  mb-96">
        {products.map((val: any, i: any) => {
          return (
            ...
            <div key={i} className="w-full max-w-sm bg-gray-800 border border-gray-400 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <div>
                <img
                  className="p-8 w-[400px] h-[400px] rounded-t-lg"
                  src={val.image} // Replace with actual image URL
                  alt="product image"
                />
              </div>
              <div className="px-5 pb-5">
                <div>
                  <h5 className="text-xl font-semibold tracking-tight text-white dark:text-white">
                    {val.title} {/* Replace with actual product title */}
                  </h5>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-3xl font-bold text-white dark:text-white">
                    ${val.price} {/* Replace with actual price */}
                  </span>
                  <Link
